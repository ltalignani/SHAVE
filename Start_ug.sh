...
echo -e "${green}-----------------${nc}"
echo ""
echo -e "${blue}Name${nc} __________________ Start_ug.sh"
...
echo -e "${blue}Run${nc} ___________________ bash Start_ug.sh"
...
snakemake \
    --directory ${workdir}/ \
    --snakefile ${workdir}/workflow/rules/shave_unifiedgenotyper.smk \
    --config os=${os} \
    --rerun-incomplete \
    --unlock \
