...
echo -e "${green}-----------------${nc}"
echo ""
echo -e "${blue}Name${nc} __________________ Start_polish4.sh"
...
echo -e "${blue}Run${nc} ___________________ bash Start_polish4.sh"
...
snakemake \
    --directory ${workdir}/ \
    --snakefile ${workdir}/workflow/rules/shave_polish4.smk \
    --config os=${os} \
    --rerun-incomplete \
    --unlock \
